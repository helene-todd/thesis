!---------------------------------------------------------------------- 
!---------------------------------------------------------------------- 
!   model :   model by Todd, Gutkin & Cayco Gajic, 2024
!---------------------------------------------------------------------- 
!---------------------------------------------------------------------- 
...
!--------- ---- 
  ...
  DOUBLE PRECISION G1, J2, A, TAUM, TAUD, ETA, DELTA, J1, G2, JC, PI
...
!     ---------- ----- 
      ...
      ! PARAMETERS
      PAR(1)  =   0.000d0           ! PARAMETER G1
      PAR(2)  =  -8.000d0           ! PARAMETER J2
      ...
      ! VARIABLES
      U(1) =  0.19403d0  ! VARIABLE R1
      U(2) =  0.025489d0 ! VARIABLE R2
      U(3) = -0.24608d0  ! VARIABLE V1
      U(4) = -0.87325d0  ! VARIABLE V2
      U(5) =  0.19403d0  ! VARIABLE S1
      U(6) =  0.025489d0 ! VARIABLE S2
