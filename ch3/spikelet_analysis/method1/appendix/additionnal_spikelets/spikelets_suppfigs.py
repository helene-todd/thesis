...
current_start0, current_stop0 = 6, 6.8
current_start1, current_stop1 = 6, 6.8
v0 = 0
...
ax[0].plot(times, v1, color='black', alpha=0.5, label='$v_{th}=$'+f'${vp}$, '+'$v_{r}=$'+f'${vr}$',linewidth=lnw, zorder=0)
ax[1].plot(times, v2, color='black', label='$v_{th}=$'+f'${vp}$, '+'$v_{r}=$'+f'${vr}$',linewidth=lnw, alpha=.5, zorder=0)
...
ax[0].plot(times, v1, color='#aa3863', alpha=.8, label='$v_{th}=$'+f'${vp}$, '+'$v_{r}=$'+f'${vr}$',linewidth=lnw, zorder=-20)
ax[1].plot(times, v2, color='#3b7c86', alpha=.8, label='$v_{th}=$'+f'${vp}$, '+'$v_{r}=$'+f'${vr}$',linewidth=lnw, zorder=-20)
...
plt.tight_layout()
plt.savefig('v_th='+f'{vp}_'+'v_r='+f'{vr}.png', dpi=300)
plt.show()
